...
from merkury.plotting import output_bokeh

iris_source = "https://raw.githubusercontent.com/mwaskom/seaborn-data/master/iris.csv"
iris = pd.read_csv("docs/iris.csv")
...
You can view script that generated it [here](https://github.com/ppatrzyk/merkury/blob/master/docs/intro-py.py).
...
If you don't specify [formatting options](https://github.com/ppatrzyk/merkury#formatting), output will be treated as python code. 
...
<p><small>Data: <a href="{iris_source}">mwaskom/seaborn-data</a></small></p>
"""
...
plot = figure(
    title="Iris species", x_axis_label="petal_width", y_axis_label="sepal_width"
)
plot.scatter(
